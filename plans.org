...
Create a virtual env with pip, using python 3.11
...
**** twitter api, virtual environments, tweet.py
...
**** BREAK
**** final project: social media bot tutorial
...
- research some tutorials for scraping and/or creating a bot for that
  ...
  minimum).
- with a partner or by yourself, create a tutorial that you will use
  to teach your classmates how to scrape or create a bot on that app.

Deliverables:
- written tutorial, in markdown (~.md~) format:
  - with each step described clearly, and code blocks to include code
    examples.
  - see the `day8_twitter_bot.md` file in /class_notes folder for a
    sample of an ~.md~ file.
- vitual presentation, 20 - 30 minutes:
  - you will present the tutorial like a lesson, where you walk your
    classmates through the process of using the tool.

Examples:
- Yin, Piotr Sapiezynski and Leon. [[https://inspectelement.org/browser_automation.html][Browser Automation]], Blog.
- Instagrapi, [[https://www.youtube.com/watch?v=cW7kMeOUr20][instagrapi tutorial]], Youtube.
- [[https://www.geeksforgeeks.org/make-an-instagram-bot-with-python/][Make an Instagram Bot With Python]], Geeks for Geeks

*** (online) June 26, session 9: automation & deployment
**** automate and deploy
## 4. automate the bot
...
*** (online) June 30, session 10: work sessions
